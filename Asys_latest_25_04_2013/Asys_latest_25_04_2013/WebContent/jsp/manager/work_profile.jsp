...
<s:div cssClass="grid_10">
            <s:div cssClass="box round first1 ">
               ...
               <s:form action="employee_edit_work_profile_click" cssClass="form" method="post">     	
                    	...
                    	<s:textarea name="workProfileDetailBean.designation" label="Designation" value="%{#request.designation}" rows="4" disabled="true" id="txt2"/>
                    		<tr>
                    		<td></td>
                    			<td>
                    	...
                    	<s:textarea name="workProfileDetailBean.skill" label="Skill" value="%{#request.skill}" rows="4" disabled="true" id="txt3"/>
                    		<tr>
                    		<td></td>
                    			<td>
 ...
 --%>               	
				...
				%>
                   ...
                   <s:form action="employee_add_work_profile_click" cssClass="form" method="post">
                    	...
                    	<s:textarea name="workProfileDetailBean.designation" label="Designation" value="%{workProfileDetailBean.designation}" rows="4" cols="15"  id="txt2"/>
                    		<tr>
                    		<td></td>
                    			<td>
                    				<s:label theme="simple">Specify Designation</s:label>
                    	...
                    	<s:textarea name="workProfileDetailBean.skill" label="Skill" value="%{workProfileDetailBean.skill}" rows="4" cols="15" id="txt3"/>
                    		<tr>
                    		<td></td>
                    			<td>
                    				<s:label theme="simple">Specify the Skill of Employee</s:label>
