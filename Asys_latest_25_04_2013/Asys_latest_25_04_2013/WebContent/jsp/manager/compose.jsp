...
<%} %>
                    <s:form  name="login_frm" action="manager_send_mail_click" cssClass="form" method="post" enctype="multipart/form-data" id="login_frm">
                    	...
                    	<s:textfield name="sentMailMasterBean.emailSubject" label="Subject" value="%{sentMailMasterBean.emailSubject}" size="65"/>
                    		...
                    		<s:textarea name="sentMailMasterBean.emailBody" cols="52" id="area1" label="Text" value="%{sentMailMasterBean.emailBody}" rows="0" />
                    		<tr>
                    		<td></td>
                    			<td>
                    				<s:label theme="simple"></s:label>
