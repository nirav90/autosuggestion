...
<s:div cssClass="grid_10">
            <s:div cssClass="box round first1 ">
                ...
                <s:div cssClass="block">
					...
					<td>
					<s:form action="employee_delete_contact_click">
					<s:hidden value="%{#request.contactId1}" name="contactDetailMasterBean.contactId"></s:hidden>
					<s:submit value="  " name="Delete" cssStyle=" margin-top:10px; background: url(\"./img/delete.png\") no-repeat scroll 0 0 transparent; height: 30px; width: 30px;" ></s:submit>
					</s:form>
					</td>
