...
public class SendMailUsage {
    ...
    public static void main(String[] args) {
        ...
        String to = "nirav90up@gmail.com";
        String from = "nirav.nirav90up@gmail.com";
        ...
        try {
            ...
            //bus.connect();
            bus.connect(host, "nirav.nirav90up@gmail.com", "09111991");
            ...
            setFileAsAttachment(msg, "E:/404.jpg");
            msg.saveChanges();
            bus.sendMessage(msg, address);
